...
const doctorData: DoctorHeaderData = {
  ...
  clinicName: "Sanskar Netralaya",
  clinicLocation: "Nungambakkam, Chennai, Tamil Nadu",
  clinicAddress: "12 Medical Road, Nungambakkam, Chennai, Tamil Nadu",
  doctorLicenseNo: "TN-MCI-009874",
